  ...
  useEffect(() => {
    ...
    class App {
      ...
      loadAssets() {
        ...
        return new Promise<void>(resolve => {
          ...
          searchImage.src = (SMAAEffect as unknown as { searchImageDataURL: string }).searchImageDataURL;
          areaImage.src = (SMAAEffect as unknown as { areaImageDataURL: string }).areaImageDataURL;
        });
      }
    ...
    class CarLights {
      ...
      init() {
        ...
        let colors: THREE.Color[] | THREE.Color = this.colors as unknown as THREE.Color[];
    ...
    class LightsSticks {
      ...
      init() {
        ...
        let colors: THREE.Color[] | THREE.Color = options.colors.sticks as unknown as THREE.Color[];
        if (Array.isArray(options.colors.sticks)) {
          colors = (options.colors.sticks as number[]).map(c => new THREE.Color(c));
        } else {
    ...
    (function () {
      ...
      const distortionKey = typeof effectOptions.distortion === 'string' ? effectOptions.distortion : 'turbulentDistortion';
      const options = { 
        ...effectOptions,
